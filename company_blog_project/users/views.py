...
def maintenance():
    ...
    # dbのデータすべてをid順に並べてmaintenanceにおくる
    return render_template('users/maintenance.html',users=users)
...
def user_posts(user_id):
    ...
    return render_template('index.html',blog_posts=blog_posts,recent_blog_post=recent_blog_post,blog_categories=blog_categories,form=form,user=user)
